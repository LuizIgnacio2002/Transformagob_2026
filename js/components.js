...
(function () {
  ...
  /** Tarjeta KPI. */
  function kpi({ value, label, hint = "", variant = "" }) {
    return `
  ...
  function barChart(rows, { accent = false } = {}) {
  ...
  App.components = {
    esc, el, STATE_META, kpi, badge, barChart, donut, fmtDate, dayMonth, emptyState, ttsButton,
  };
})();
