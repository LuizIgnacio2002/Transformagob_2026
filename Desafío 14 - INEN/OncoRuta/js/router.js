/* ============================================================
   ...
   ------------------------------------------------------------
   Cada vista exporta { render(ctx) -> string, mount?(root, ctx) }.
...
import { ROUTES, APP } from "./config.js";
import { t } from "./i18n.js";
import { esc } from "./components.js";

import * as login from "./views/login.js";
import * as dashboard from "./views/dashboard.js";
import * as ruta from "./views/ruta.js";
import * as citas from "./views/citas.js";
import * as documentos from "./views/documentos.js";
import * as orientacion from "./views/orientacion.js";
import * as notificaciones from "./views/notificaciones.js";
import * as apoyo from "./views/apoyo.js";
...
const VIEWS = {
  dashboard, ruta, citas, documentos, orientacion, notificaciones, apoyo, perfil,
  panel, pacientes, indicadores,
};
...
function bindShell(app, session) {
  ...
  app.querySelector('[data-action="toggle-nav"]')?.addEventListener("click", () => {
